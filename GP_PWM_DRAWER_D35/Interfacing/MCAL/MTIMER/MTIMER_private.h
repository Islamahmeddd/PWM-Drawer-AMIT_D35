...
#define MTIMER1_TCCR1A			 (*(volatile u8_t*)0x4F)
#define MTIMER1_TCCR1B			 (*(volatile u8_t*)0x4E)
#define MTIMER1_TCNT1H			 (*(volatile u8_t*)0x4D)
#define MTIMER1_TCNT1L			 (*(volatile u8_t*)0x4C)
#define MTIMER1_ICR1H		     (*(volatile u8_t*)0x47)
#define MTIMER1_ICR1L		   	 (*(volatile u8_t*)0x46)
/***************************************************************************************************/
